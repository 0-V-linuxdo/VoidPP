...
| <img src="https://api.iconify.design/lucide/list-ordered.svg?color=%238b949e" width="16" height="16" alt=""> BetterQueue | On | The queue chip menu marks that row's mode, not the composer. |
