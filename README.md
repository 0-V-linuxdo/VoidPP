...
| <img src="https://api.iconify.design/lucide/text-cursor-input.svg?color=%238b949e" width="16" height="16" alt=""> Placeholder | Off | Replace the non-project home greeting. Outside projects the input keeps Grok's placeholder (`heroOnlyOutsideProject`, on by default). Project chats still use the first phrase. Greeting rotation: visit / timer / click (`mode`, `order`, `intervalSec`). Optional `imaginePhrases` for the Imagine query bar. |
