...
| <img src="https://api.iconify.design/lucide/list-ordered.svg?color=%238b949e" width="16" height="16" alt=""> ModeSync | On | Queued messages send with the current picker. Switching chats keeps the selected mode (`stickyOnNavigate`). |
