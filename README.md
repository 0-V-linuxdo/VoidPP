...
| <img src="https://api.iconify.design/lucide/user-round-pen.svg?color=%238b949e" width="16" height="16" alt=""> CustomSidebarIdentity | Off | Replace the sidebar avatar and display name. Empty fields keep the official values. Paste a picture into Avatar Url (or type `https://` / `data:image`), then drag/zoom the circle to crop. Optional `applyToMenu` also covers the account dropdown header. |
