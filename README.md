...
| <img src="https://api.iconify.design/lucide/star.svg?color=%238b949e" width="16" height="16" alt=""> MessageStars | Off | Star any message. Hover the right navigator and click the star on a row. Click the star above the ticks to open the starred list on the left of the rail. Starred ticks turn orange. The message ⋯ menu still has Star / Unstar. |
