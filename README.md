...
| <img src="https://api.iconify.design/lucide/star.svg?color=%238b949e" width="16" height="16" alt=""> MessageStars | Off | Star any message. Long-press a navigator tick, or use the message menu. Starred ticks turn orange, and the left sidebar lists them (`showInSidebar`). |
