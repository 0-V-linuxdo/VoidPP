...
| <img src="https://api.iconify.design/lucide/star.svg?color=%238b949e" width="16" height="16" alt=""> MessageStars | 关 | 收藏任意一条消息。长按右侧导航 tick，或在消息菜单里加星。收藏的 tick 变橙色，左侧栏列出收藏（`showInSidebar`）。 |
