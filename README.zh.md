...
| <img src="https://api.iconify.design/lucide/user-round-pen.svg?color=%238b949e" width="16" height="16" alt=""> CustomSidebarIdentity | 关 | 替换侧栏头像和显示名。留空则保持官方。Avatar Url 支持粘贴图片或填 `https://` / `data:image`，圆形台可拖拽/缩放裁切。可选 `applyToMenu` 同时改账号下拉顶栏。 |
